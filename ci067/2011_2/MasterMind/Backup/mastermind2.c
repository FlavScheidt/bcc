...
************************/
/************************
	Última modificação: 11/Dez/2011 14:40
************************/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int ExisteLista(lista *l, char *tentativa)
{
	...
	nodo *n;
	for (n = PrimeiroNodo(l); n -> proximo != NULL; n = Sucessor(n, l))
	{
...
void GeraLista(char *tentativa, char *novaTentativa, int P, int Q, lista *l, int n, int inicio)
{
	//int Pc, Qc;
	int i;
	char aux;
...
void gera_tentativa(int k, int P, int Q, char *tentativa) 
{
	...
	switch (estado)
	{
		...
		case 1: //Segunda rodada
			...
			GeraLista(tentativa, novaTentativa, P, Q, l, M, 0);
